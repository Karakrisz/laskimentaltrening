                    ...
                    <div class="footer-widget__column footer-widget__about">
                        ...
                        <div class="footer-widget__about-text-box">
                            <p class="footer-widget__about-text">Laski Vivien vagyok sport mentáltréner, rekreáció-,
                                életmód- és egészségfejlesztő, szakedző és life coach. Több mint 20 éve mozgom a
                                versenysport világában.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="footer-widget__column footer-widget__contact clearfix">
                        ...
                        <ul class="footer-widget__contact-list list-unstyled clearfix">
                            <li>
                                ...
                                <div class="text">
                                    <p><a href="mailto:laski.mentaltrening@gmail.com">laski.mentaltrening@gmail.com</a>
                                    </p>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="text">
                                    <p><a href="tel:+36707788589">+36 70 778 8589</a></p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                        ...
                        <ul class="footer-widget__contact-social-link">
                            <li>
                                <a target="_blank" href="https://www.facebook.com/laskisportmentaltrener"><span
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="site-footer__bottom-inner">
                        <p class="site-footer__bottom-text">© 2022 <a href="https://www.yousite.hu/">YouSite</a>

            ...
            <div class="container">
                <div class="page-header__inner">
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li><span>//</span></li>
                        <li class="color-base">Kapcsolat</li>
                    </ul>
            ...
            <div class="container">
                <div class="contact-page__top">
                    <div class="title text-center">
                        <h2>Nyugodtan tedd fel kérdéseidet, <br>vagy írj üzentet.</h2>
                        <p>Elérsz minket telefonon vagy e-mailben is, számos variáció van.</p>
                    </div>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="contact-page__top-single">
                            ...
                            <div class="content">
                                <h2>Telefon</h2>
                                <p>
                                    <a href="tel:+36707788589">+36 70 778 8589</a>
                                </p>
                            </div>
                        </li>
                        <!--End Contact Page Top single-->
                        ...
                        <li class="contact-page__top-single">
                            ...
                            <div class="content">
                                <h2>E-mail cím</h2>
                                <p>
                                    <a href="mailto:laski.mentaltrening@gmail.com">laski.mentaltrening@gmail.com</a>
                                </p>
                            </div>
                        </li>
                        <!--End Contact Page Top single-->
                ...
                <div class="contact-page__bottom">
                    <form action="assets/inc/sendemail.php" class="contact-page__form contact-form-validated">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                <div class="contact-page__input-box">
                                    <input type="email" placeholder="Email cím" name="email">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                <div class="contact-page__input-box">
                                    <input type="email" placeholder="Üzenet tárgya" name="Subject">
                                </div>
                            </div>
                        </div>
                        <div class="row">
